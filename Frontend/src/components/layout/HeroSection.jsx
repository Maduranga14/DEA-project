              ...
              Trusted by 50,000+ professionals worldwide
                    ...
                    >
                        <form onSubmit={handleSearch} className="relative">
                            ...
                            />
                            {/* Fixed Button - No movement on hover */}
                            <div className="absolute right-2 top-1/2 transform -translate-y-1/2" style={{ width: 'fit-content' }}>
                                <motion.button
                                    whileHover={{ scale: 1.05 }}
                                    whileTap={{ scale: 0.95 }}
                                    type="submit"
                                    className="bg-gradient-to-r from-cyan-500 to-blue-600 text-white px-8 py-3 rounded-xl font-semibold flex items-center space-x-2 shadow-lg"
                                    style={{
