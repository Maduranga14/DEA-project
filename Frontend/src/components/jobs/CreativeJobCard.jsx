                    ...
                    <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between">
                        ...
                        <div className="flex-1">
                                ...
                                <div>
                                    ...
                                    <div className="flex items-center space-x-4 text-sm text-gray-600 mb-3">
                                        <div className="flex items-center">
                                            ...
                                            <span>{job.clientName || job.client?.name || 'Anonymous'}</span>
                                        </div>
                                        <div className="flex items-center">
                                        ...
                                        <div className="flex items-center">
                                            ...
                                            <span>{job.createdAt ? new Date(job.createdAt).toLocaleDateString() : job.posted}</span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="flex flex-wrap gap-2 mb-4">
                                {(job.requiredSkills || job.skills || []).slice(0, 4).map((skill, index) => (
                                    <span
                                        key={skill}
                ...
                <div className="p-6">
                    ...
                    <div className="flex items-center justify-between mb-4">
                        <div className="flex items-center">
                            ...
                            <div className="ml-3">
                                <div className="font-semibold text-gray-900">{job.clientName || job.client?.name || 'Anonymous'}</div>
                                <div className="text-sm text-gray-500 flex items-center">
                                    <Star className="w-3 h-3 mr-1 fill-yellow-400 text-yellow-400" />
                                    {job.client?.rating || '4.5'}/5
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="text-right">
                            ...
                            <div className="text-sm text-gray-500">{formatDuration(job)}</div>
                        </div>
                    </div>
