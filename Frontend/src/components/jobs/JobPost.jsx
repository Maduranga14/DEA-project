    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            const projectData = {
                ...
                jobType: data.jobType === 'FIXED' ? 'FIXED_PRICE' : 'HOURLY',
                experienceLevel: data.experienceLevel ? data.experienceLevel.toUpperCase() : 'INTERMEDIATE',
                                    ...
                                    <div>
                                        ...
                                        <div className="space-y-6">
                                            ...
                                            <div>
                                                ...
                                                <div className="flex flex-wrap gap-2">
                                                    {['React', 'Vue.js', 'Angular', 'JavaScript', 'TypeScript', 'HTML/CSS', 'Tailwind CSS', 'Bootstrap', 'Sass/SCSS', 'jQuery'].map((skill) => (
                                            ...
                                            <div>
                                                ...
                                                <div className="flex flex-wrap gap-2">
                                                    {['Node.js', 'Python', 'Java', 'PHP', 'C#', 'Ruby', 'Go', 'Express.js', 'Django', 'Spring Boot', 'Laravel', 'ASP.NET'].map((skill) => (
                                                        <SkillButton key={skill} skill={skill} />
                                                    ))}
                                                </div>
                                            </div>
                                            ...
                                            <div>
                                                ...
                                                <div className="flex flex-wrap gap-2">
                                                    {['MySQL', 'PostgreSQL', 'MongoDB', 'Redis', 'AWS', 'Azure', 'Google Cloud', 'Docker', 'Kubernetes', 'Firebase'].map((skill) => (
                                                        <SkillButton key={skill} skill={skill} />
                                                    ))}
                                                </div>
                                            </div>
                                            ...
                                            <div>
                                                ...
                                                <div className="flex flex-wrap gap-2">
                                                    {['UI/UX Design', 'Graphic Design', 'Figma', 'Adobe Photoshop', 'Adobe Illustrator', 'Sketch', 'Prototyping', 'Wireframing', 'Branding'].map((skill) => (
                                                        <SkillButton key={skill} skill={skill} />
                                                    ))}
                                                </div>
                                            </div>
                                            ...
                                            <div>
                                                ...
                                                <div className="flex flex-wrap gap-2">
                                                    {['React Native', 'Flutter', 'iOS Development', 'Android Development', 'Swift', 'Kotlin', 'Xamarin'].map((skill) => (
                                                        <SkillButton key={skill} skill={skill} />
                                                    ))}
                                                </div>
                                            </div>
                                            ...
                                            <div>
                                                ...
                                                <div className="flex flex-wrap gap-2">
                                                    {['DevOps', 'Machine Learning', 'Data Analysis', 'SEO', 'Digital Marketing', 'Content Writing', 'Project Management', 'Testing/QA'].map((skill) => (
                                                        <SkillButton key={skill} skill={skill} />
                                                    ))}
                                                </div>
                                            </div>
                                        ...
                                        <div className="mt-6 pt-6 border-t border-gray-200">
                                            ...
                                            <p className="text-sm text-gray-500 mt-2">
                                                Can't find the skill you need? Add it here.
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="mt-8 p-6 bg-blue-50 rounded-xl border border-blue-200">
                                        ...
                                        {selectedSkills.length > 0 ? (
                                            <div className="flex flex-wrap gap-2">
                                                {selectedSkills.map((skill, index) => (
                                                    <motion.span
                                                        ...
                                                        className="bg-blue-500 text-white px-4 py-2 rounded-full text-sm font-medium flex items-center space-x-2 shadow-sm"
                                                    >
                                                        <span>{skill}</span>
                                                        <button
                                                            type="button"
                                            ...
                                            <p className="text-blue-600 text-sm">
                                                Select skills from the categories above or add custom skills.
                                            </p>
                                        )}
                                    </div>
